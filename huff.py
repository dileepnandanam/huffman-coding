...
def test():
	c=Compressor("aaaaaaaaaabbbbqwertyuiopasdfghjklzxcvbnmbbbcccccddddeeeffg")
	assert(c.decode(c.encode("abcde"))=="abcde")
	assert(c.decode(c.encode("aaaaaaaacccccdag"))=="aaaaaaaacccccdag")
	assert(c.encode(c.decode("1111"))=="1111")
	assert(c.decode(reduce(lambda x,y:x+y,list(c.quickEncode("gfdhgdgfd"))))=="gfdhgdgfd")
test()	
